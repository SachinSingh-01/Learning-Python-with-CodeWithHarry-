 ...
 # used and manipulated throughout a program. A variable is 
 # created the moment you assign  a value to it using the
# assignment operator (=).
...
#a$$ge =45 # Invalid because variables cannot contain special character other than (-)
__age=34
__nice_45=32
a_b_c_7="Sachin"
